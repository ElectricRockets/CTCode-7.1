...
public class DriveConstants {
    ...
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(15, 0, 10,
            /*getMotorVelocityF(MAX_RPM / 60 * TICKS_PER_REV)*/ 13.3);
    ...
    public static double GEAR_RATIO = 0.07008; // output (wheel) speed / input (motor) speed
     ...
     * empirically tuned.
     */
    public static double kV = 0.0138/*1.0 / rpmToVelocity(MAX_RPM)*/;
