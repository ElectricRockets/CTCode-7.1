...
public class BlueConstants {
    public static Pose2d CYCLE_START = new Pose2d(12, 65, toRadians(90));
    ...
    public static Pose2d GAP = new Pose2d(24, 65, toRadians(0));
    public static Pose2d CYCLE_COLLECT = new Pose2d(48, 65, toRadians(0));
    ...
    public static Pose2d WAREHOUSE_PARK = new Pose2d(40, 65, toRadians(0));
