...
public class RedConstants {
    ...
    public static Pose2d IW1 = new Pose2d(45, -63, toRadians(-25));
    public static Vector2d IW2 = new Vector2d(IW1.getX() + 4, IW1.getY());
    public static Vector2d IW2_OFFSET = new Vector2d(2.5,0);

    public static Pose2d CYCLE_TSELEFT = new Pose2d(15, -42.5, toRadians(139) + toRadians(180));
    public static Pose2d CYCLE_TSEMID = new Pose2d(13, -46.5, toRadians(90) + toRadians(180));
    public static Pose2d CYCLE_TSERIGHT = new Pose2d(12.5, -42.5, toRadians(41) + toRadians(180));

    public static Pose2d WAREHOUSE_PARK = new Pose2d(40, -64, toRadians(0));

    public static Pose2d DUCK_START = new Pose2d(-29, -61, toRadians(-90));
