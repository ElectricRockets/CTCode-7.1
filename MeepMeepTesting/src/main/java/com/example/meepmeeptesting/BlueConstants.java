...
public class BlueConstants {
    ...
    public static Pose2d CYCLE_TSERIGHT = new Pose2d(3.5, 48.5, toRadians(-90) + toRadians(180));
    ...
    public static Pose2d DUCK_TSELEFT = new Pose2d(-27.5, 48, toRadians(-90));
    public static Pose2d DUCK_TSEMID = new Pose2d(-36, 48, toRadians(-90));
    public static Pose2d DUCK_TSERIGHT = new Pose2d(-44.5, 48, toRadians(-90));
    public static Pose2d CAROUSEL = new Pose2d(-60, 57, toRadians(-135));
