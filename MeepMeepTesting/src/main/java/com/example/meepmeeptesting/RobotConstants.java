...
public class RobotConstants {
    ...
    public static double TSE_ARM_STORE_FRONT = 0.17;
    ...
    public static double UNIVERSAL_DELIVERY_TIME = 5;
    public static double UNIVERSAL_DELIVERY_ACCEL = 0.25;
    public static double UNIVERSAL_DELIVERY_MAX_SPEED = 0.45;

    public static double INTAKE_RAMP_LOW = 0.73;
